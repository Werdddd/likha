...
const projectSeeds: Array<{
  ...
  { creatorId: 'c1', title: 'Buwan ng Wika Editorial Series', description: 'A five-piece illustration series celebrating Filipino language for a national magazine feature.', mediums: ['watercolor', 'editorial'], category: 'Illustration', region: 'NCR' },
  { creatorId: 'c1', title: 'Jeepney Dreams', description: 'Character study exploring jeepney culture through bold color and pattern.', mediums: ['digital', 'character design'], category: 'Illustration', region: 'NCR' },
  { creatorId: 'c1', title: 'Sinulog Spirit', description: 'Festival-inspired poster set commissioned for a Cebu cultural event.', mediums: ['poster', 'festival'], category: 'Illustration', region: 'NCR' },
  { creatorId: 'c2', title: 'Sari-Sari App Redesign', description: 'End-to-end UX case study: problem, process, and solution for a neighborhood store ordering app.', mediums: ['mobile', 'case study'], category: 'UI/UX Design', region: 'Central Visayas' },
  { creatorId: 'c2', title: 'Likha Design System', description: 'Component library and design tokens built for a creator marketplace.', mediums: ['design systems'], category: 'UI/UX Design', region: 'Central Visayas' },
  { creatorId: 'c2', title: 'Lalamove Driver App Flows', description: 'Onboarding and delivery-tracking flow improvements for a logistics app.', mediums: ['mobile', 'flows'], category: 'UI/UX Design', region: 'Central Visayas' },
  { creatorId: 'c3', title: 'Davao Streets, Vol. 2', description: 'A black-and-white film series documenting everyday life in Davao.', mediums: ['film', 'street'], category: 'Photography', region: 'Davao Region' },
  { creatorId: 'c3', title: 'Portraits of the Market', description: 'Portrait series shot at Bankerohan Public Market, gear: Pentax K1000, Kodak Portra 400.', mediums: ['portraits', 'film'], category: 'Photography', region: 'Davao Region' },
  { creatorId: 'c3', title: 'Golden Hour, Samal', description: 'Landscape and lifestyle set from Samal Island at sunset.', mediums: ['landscape'], category: 'Photography', region: 'Davao Region' },
  { creatorId: 'c4', title: 'Aswang Reimagined', description: 'Stylized 3D character renders reinterpreting Filipino folklore creatures.', mediums: ['blender', 'folklore'], category: '3D Art', region: 'NCR' },
  { creatorId: 'c4', title: 'Barong Motif Study', description: 'Procedural 3D pattern experiments inspired by barong tagalog embroidery.', mediums: ['procedural', 'pattern'], category: '3D Art', region: 'NCR' },
  { creatorId: 'c5', title: 'Manggahan Brand Identity', description: 'Full branding suite for a mango farm cooperative, with banig-inspired patterns.', mediums: ['branding', 'pattern'], category: 'Graphic Design', region: 'Western Visayas' },
  { creatorId: 'c5', title: 'Dinagyang Type Poster', description: 'Hand-lettered festival poster celebrating Iloilo’s Dinagyang.', mediums: ['lettering', 'poster'], category: 'Graphic Design', region: 'Western Visayas' },
  { creatorId: 'c6', title: 'Weaving the Cordillera', description: 'Process journal documenting a traditional Cordillera weaving piece from start to finish.', mediums: ['weaving', 'heritage'], category: 'Crafts', region: 'CAR' },
  { creatorId: 'c6', title: 'Pinewood Carving Series', description: 'A set of hand-carved pinewood figures inspired by Baguio folklore.', mediums: ['woodcraft'], category: 'Crafts', region: 'CAR' },
  { creatorId: 'c7', title: 'Brand Voice: Local Coffee Co.', description: 'Copywriting case study for a Negros-based coffee brand’s full launch campaign.', mediums: ['copywriting', 'brand voice'], category: 'Writing', region: 'Western Visayas' },
  { creatorId: 'c7', title: 'Essays on Coming Home', description: 'A personal essay collection about balikbayan life, published in a local zine.', mediums: ['essays'], category: 'Writing', region: 'Western Visayas' },
];
