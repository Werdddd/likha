...
export default function CheckoutScreen() {
  ...
  const [paymentProof, setPaymentProof] = useState<ProofValue | null>(null);
    ...
    <SafeAreaView style={styles.screen} edges={['left', 'right', 'bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <MilestoneProofUpload
          ...
          hint={`Send payment via ${PAYMENT_METHODS.find((m) => m.value === paymentMethod)?.label} first, then upload a screenshot or photo of your receipt. The seller will verify it before fulfilling your order.`}
        />
